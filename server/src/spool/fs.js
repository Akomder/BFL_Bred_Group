...
/* Filesystem spool driver — the original, and the right one wherever the
   process owns a persistent disk (the VPS under systemd, and local dev).
   Selected by default; see spool.js for how a driver is chosen.
